...
describe('Pruebas a la api de compra', () => {
    it('Validacion de usuario existente', async done => {
        var res = await request.get('/history/5f950dc9191d602c64f42b28');
    ...
    it('Consulta correcta de historial', async done => {
        var res = await request.get('/history/5f950dc9191d602c64f42b27');
